...
public class BookTest extends TestCase {
    ...
    public static void testGetBookName() {
        ...
        for(int i=0;i<bookNames.length;i++){
            Book b = new Book("1111111111111",bookNames[i],"Dan",15,15);
    ...
    public static void testGetBookAuthor() {
        ...
        for(int i=0;i<bookAuthors.length;i++){
            Book b = new Book("1111111111111","Doraemon",bookAuthors[i],15,15);
    ...
    public static void testGetPrice() {
        ...
        for(int i=0;i<bookPrices.length;i++){
            Book b = new Book("1111111111111","Doraemon","Dan",bookPrices[i],15);
    ...
    public static void testGetBookIsbn() {
        ...
        for(int i=0;i<bookIsbn.length;i++){
            Book b = new Book(bookIsbn[i],"Doraemon","Dan",15,15);
    ...
    public static void testGetStockAmount() {
        ...
        for(int i=0;i<bookStock.length;i++){
            Book b = new Book("1111111111111","Doraemon","Dan",15,bookStock[i]);
            assertEquals(b.getStockAmount(),bookStock[i]);
        }
    }
    ...
    public static void testSetPrice() {
        ...
        Book b1 = new Book("1111111111111","Doraemon","Dan",50,20);
        b1.setPrice(100);
        assertEquals(b1.getPrice(),100);

        Book b2 = new Book("1111111111111","Doraemon","Dan",0,20);
        b2.setPrice(200);
    ...
    public static void testSetStockAmount() {
        ...
        Book b = new Book("1111111111111","Doraemon","Dan",15,20);
        b.setStockAmount(30);
        assertEquals(b.getStockAmount(),30);

        Book b1 = new Book("1111111111111","Doraemon","Dan",15,40);
        b1.setStockAmount(80);
        assertEquals(b1.getStockAmount(),80);

        Book b2 = new Book("1111111111111","Doraemon","Dan",15,1);
        b2.setStockAmount(200);
        assertEquals(b2.getStockAmount(),200);
    }
}