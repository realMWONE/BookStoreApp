...
Our project simulates a bookstore system, thus we decided to work on searching the book by ISBN, title and author name. This is one of 
most important and basic feature that the bookstore system is supposed to have. 
